...
const SocialIcon = ({ type, url, ariaLabel }) => {
    const paths = {
        linkedin: "M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z",
        twitter: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.627l-5.21-6.815-6.041 6.815h-3.308l7.73-8.805-7.956-10.69h6.767l4.634 6.253zm-1.149 18.48h1.786l-12.6-16.845h-1.93l12.744 16.845z",
    ...
    return (
        <a href={url} target="_blank" rel="noopener noreferrer" aria-label={ariaLabel}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path d={paths[type]} /></svg>
        </a>
    );
};
                                ...
                                <div className="portfolio-actions">
                                    {project.action === 'contact' ? (
                                        <div className="portfolio-contact-cta">
                                            <p>{content.portfolio.contact_cta}</p>
                                            <button
...
.portfolio-contact-cta p {
    ...
    color: var(--text-color);
    margin: 0;
    flex-grow: 0; /* Override .card p if necessary */
}

.portfolio-contact-cta .cta-button {
    width: 100%;
    text-align: center;
}
